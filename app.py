...
input = """please extract all I emphasize all data  and line items and format out put to strictly json. dont aggregate simmilar or duplicated rows.. strictly to this format of  12 features don't give
 me anything else. Check for rollups and individual line items.remember this is important Folio account number is sometimes regarded as customer no or custmer p/o number. it is never ever null try and
   find it.Also vat is also never null, if it's not the vat should be 15 percent of price.you can lookup the Silo Name from""" + str(silos['SILO NAME'].values) + """.I want only the 12 features. this is important.  12 features remember this  [   {   "Folio Account Number":423423,
       ...
       "Invoice Date": "2024-10-30",     "Units": 1000,     "Price": 22760.62,     "Total Excl": 22760.62,     "Vat": 3414.09,     "Total Incl": 26174.71,     "Item Description": "DAY STORAGE BREDASDORP"   },
             {     "Folio Account Number":423423,  "Supplier": "AFRICAN GRAIN INVESTMENTS (PTY)" ,   "Client":"Overberg Agri Bedrywe (Edms) Bpk",   "Invoice number": "MIVP123083083/2",   "Document Type": "Belasting Faktuur",
                       "Invoice Date": "2024-10-30",     "Units": 1000,     "Price": 69193.59,     "Total Excl": 69193.59,     "Vat": 10379.04,     "Total Incl": 79572.63,     "Item Description": "DAY STORAGE NAPIER"   },
                             {     "Folio Account Number":423423,  "Supplier": "AFRICAN GRAIN INVESTMENTS (PTY)" ,   "Client":"Overberg Agri Bedrywe (Edms) Bpk",   "Invoice number": "MIVP123083083/2",
                                   "Document Type": "Belasting Faktuur",     "Invoice Date": "2024-10-30",     "Units": 1000,     "Price": 89199.79,     "Total Excl": 89199.79,     "Vat": 13379.97,     
                                   "Total Incl": 102579.76,     "Item Description": "DAY STORAGE KLIPDALE"   },   {   "Folio Account Number":423423,     "Supplier": "AFRICAN GRAIN INVESTMENTS (PTY)" ,   
                                   ...
                                   "Price": 39161.00,     "Total Excl": 39161.00,     "Vat": 5874.15,     "Total Incl": 45035.15,     "Item Description": "DAY STORAGE PROTEM"   },   {    "Folio Account Number":423423,   
                                   "Supplier": "AFRICAN GRAIN INVESTMENTS (PTY)" ,   "Client":"Overberg Agri Bedrywe (Edms) Bpk",   "Invoice number": "MIVP123083083/2",  "Document Type": "Belasting Faktuur",     
                                   "Invoice Date": "2024-10-30",     "Units": 1000,     "Price": 119016.49,     "Total Excl": 119016.49,     "Vat": 17852.47,     "Total Incl": 136868.96,     
                                   "Item Description": "DAY STORAGE CALEDON"   },   {     "Folio Account Number":423423,  "Supplier": "AFRICAN GRAIN INVESTMENTS (PTY)" ,   "Client":"Overberg Agri Bedrywe (Edms) Bpk",  
                                     ...
                                     "Vat": 6350.75,     "Total Incl": 48689.07,     "Item Description": "DAY STORAGE KRIGE"   },   {     "Folio Account Number":423423,   "Supplier": "AFRICAN GRAIN INVESTMENTS (PTY)" ,   
                                     ...
                                     {   "Folio Account Number":423423,    "Supplier": "AFRICAN GRAIN INVESTMENTS (PTY)" ,   "Client":"Overberg Agri Bedrywe (Edms) Bpk",    "Invoice number": "MIVP123083083/2",  
                                       ...
                                       "Total Incl": 13373.35,     "Item Description": "STOCK CARRY OVER RIETPOEL"   },   { "Folio Account Number":423423,   "Supplier": "AFRICAN GRAIN INVESTMENTS (PTY)" ,   
                                       ...
                                       "Units": 4952.135,     "Price": 255.00,     "Total Excl": 1263334.27,     "Vat": 189419.16,     "Total Incl": 1452753.43,     "Item Description": "LONG TERM STOCK BREDASDORP"   },  
                                         ...
                                         "Total Incl": 209945.10,     "Item Description": "LONG TERM STOCK KLIPDALE"   },   {    "Folio Account Number":423423,  "Supplier": "AFRICAN GRAIN INVESTMENTS (PTY)" ,  
                                           "Client":"Overberg Agri Bedrywe (Edms) Bpk",    "Invoice number": "MIVP123083083/2",   "Document Type": "Belasting Faktuur",     "Invoice Date": "2024-10-30",     
                                           ...
                                           "Total Incl": 185974.72,     "Item Description": "LONG TERM STOCK CALEDON"   },   {   "Folio Account Number":423423,  "Supplier": "AFRICAN GRAIN INVESTMENTS (PTY)" ,  
                                             "Client":"Overberg Agri Bedrywe (Edms) Bpk",    "Invoice number": "MIVP123083083/2",   "Document Type": "Belasting Faktuur",     "Invoice Date": "2024-10-30",    
